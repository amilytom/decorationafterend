  ...
  <div class="table">
    ...
    <div class="container">
      ...
      >
        ...
        <el-table-column prop="articleTitle" label="对应文章">
          <template slot-scope="scope" v-if="scope.row.articleTitle">
            <div>
              {{ scope.row.articleTitle }}（id:{{ scope.row.articleId }}）
            </div>
          </template>
        </el-table-column>
    ...
    <!-- 添加弹出框 -->
    <el-dialog title="添加活动" :visible.sync="addVisible" width="40%">
