<template>
  <div class="table">
    ...
    <div class="container">
      ...
      >
        <el-table-column prop="id" label="案例id"> </el-table-column>
        <el-table-column prop="name" label="案例名称" sortable>
        </el-table-column>
        ...
        <el-table-column prop="desc" label="摘要" sortable> </el-table-column>
    ...
    <!-- 添加弹出框 -->
    <el-dialog title="添加案例" :visible.sync="addVisible" width="60%">
    ...
    <!-- 编辑弹出框 -->
    <el-dialog title="修改案例" :visible.sync="editVisible" width="60%">
